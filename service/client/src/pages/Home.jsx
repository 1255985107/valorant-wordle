  ...
  */
  ...
  return (
    <div className="home-container">
      ...
      <div className="home-footer">
        <p>
          Guess the mysterious VALORANT player!
          <br/>
          Idea from <a href="https://blast.tv/counter-strikle">BLAST.tv</a>&<a href="https://github.com/kennylimz/anime-character-guessr">anime-character-guessr</a>,
          Data from<a href="https://vlr.gg/">VLR.GG</a>.<br/>
        </p>
      </div>
    </div>
  );
